...
public class Officer {
	...
	public Integer getCampoEstado() {
		return campoEstado;
	}

	public void setCampoEstado(Integer campoEstado) {
		this.campoEstado = campoEstado;
	}

	public Date getCampoRegFecha() {
		return campoRegFecha;
	}

	public void setCampoRegFecha(Date campoRegFecha) {
		this.campoRegFecha = campoRegFecha;
	}

	public Long getCampoRegUsu() {
		return campoRegUsu;
	}

	public void setCampoRegUsu(Long campoRegUsu) {
		this.campoRegUsu = campoRegUsu;
	}

	public Date getCampoActFecha() {
		return campoActFecha;
	}

	public void setCampoActFecha(Date campoActFecha) {
		this.campoActFecha = campoActFecha;
	}

	public Long getCampoActUsu() {
		return campoActUsu;
	}

	public void setCampoActUsu(Long campoActUsu) {
		this.campoActUsu = campoActUsu;
	}

	public Boolean getCampoEliminado() {
		return campoEliminado;
	}

	public void setCampoEliminado(Boolean campoEliminado) {
		this.campoEliminado = campoEliminado;
	}
